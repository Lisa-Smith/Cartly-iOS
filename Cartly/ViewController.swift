...
class ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    let locations = ["Art and Design Center", "Arbor Court", "Athletics Office Building", "Bayramian Hall", "Brown Center", "Central Plant", "Chaparral Hall", "Chicano House", "Childrens Center", "Citrus Hall", "Cypress Hall", "Donald Bianchi Planetarium", "Duck Pond", "Education", "Eucalyptus Hall", "Extended University Commons", "Grand Salon(USU)", "Jacaranda Hall", "Jeanne Chisholm Hall (NCOD)", "Jerome Richfield Hall", "Johnson Auditorium", "Juniper Hall", "Klotz Student Health Center", "Laurel Hall", "Live Oak Hall", "Magnolia Hall", "Manzanita Hall", "Matador Bookstore", "Matador Hall", "Monterey Hall", "Nautilus Center/Fitness Center", "Nordhoff Hall", "Noski Auditorium", "Orange Grove", "Orange Grove Bistro", "Oviatt Library", "Police Services (DPS)", "Sagebrush Hall", "Santa Susana Hall", "Student Recreation Center (SRC)","Redwood Hall/Matadome", "Sequoia Hall", "Sierra Center", "Sierra Hall", "Tseng College", "University Hall", "University Student Union(USU)", "Valley Performing Arts Center (VPAC)","B1 Parking Lot", "B2 Parking Lot", "B3 Parking Lot", "B3 Parking Structure", "B4 Parking Lot", "B5 Parking Lot", "B5 Parking Structure", "D6 Parking Lot", "E6 Parking Lot", "F5 Parking Lot", "G1 Parking Lot", "G3 Parking Lot", "G3 Parking Structure", "G4 Parking Lot", "Baseball Field", "Tennis Courts", "Matador Track Stadium", "Sand Volleyball", "Soccer Field", "Soccer Practice Field", "Softball Field"]
